...
import stream_proto_pb2 as stream__proto__pb2
...
class MultiGreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sayHello = channel.unary_stream(
                ...
                request_serializer=stream__proto__pb2.HelloRequest.SerializeToString,
                response_deserializer=stream__proto__pb2.HelloReply.FromString,
                )
...
def add_MultiGreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'sayHello': grpc.unary_stream_rpc_method_handler(
                    servicer.sayHello,
                    request_deserializer=stream__proto__pb2.HelloRequest.FromString,
                    response_serializer=stream__proto__pb2.HelloReply.SerializeToString,
            ),
    }
...
class MultiGreeter(object):
    ...
    def sayHello(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/hellostreamingworld.MultiGreeter/sayHello',
            stream__proto__pb2.HelloRequest.SerializeToString,
            stream__proto__pb2.HelloReply.FromString,

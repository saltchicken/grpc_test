...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHelloAgain = channel.unary_unary(
                '/proto.Greeter/SayHelloAgain',
                request_serializer=proto__pb2.HelloRequest.SerializeToString,
                response_deserializer=proto__pb2.HelloReply.FromString,
                )
        self.SayHelloStreamReply = channel.unary_stream(
                '/proto.Greeter/SayHelloStreamReply',
                request_serializer=proto__pb2.HelloRequest.SerializeToString,
                response_deserializer=proto__pb2.HelloReply.FromString,
                )
...
class Greeter(object):
    ...
    def SayHelloAgain(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/proto.Greeter/SayHelloAgain',
            proto__pb2.HelloRequest.SerializeToString,
            proto__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SayHelloStreamReply(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/proto.Greeter/SayHelloStreamReply',
            proto__pb2.HelloRequest.SerializeToString,
            proto__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
